...
| Документ | О чём |
|----------|--------|
| **[00-buy-me.md](00-buy-me.md)** | **Купи меня** — зачем Intent, киллер-фичи |
| [01-overview.md](01-overview.md) | Идея, место в архитектуре, когда нужен |
...
| [07-api.md](07-api.md) | Краткий справочник API |

Быстрый старт — в [README](../README.md). Вход в историю — с **[купи меня](00-buy-me.md)**.
